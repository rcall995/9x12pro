-- ============================================
-- IMPORT YOUR 31 REAL CLIENTS
-- ============================================

-- Delete test clients first
DELETE FROM clients WHERE user_email = 'lastcall.me@hotmail.com';

-- Import all 31 real clients
...
SELECT business_name, category, phone FROM clients WHERE user_email = 'lastcall.me@hotmail.com' ORDER BY business_name LIMIT 10;
