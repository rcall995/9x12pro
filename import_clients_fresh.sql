-- ============================================
-- IMPORT CLIENTS - Fresh Import
-- ============================================

-- Delete any existing clients first
DELETE FROM clients WHERE user_email = 'lastcall.me@hotmail.com';

-- Import all 31 clients
...
SELECT business_name, category FROM clients WHERE user_email = 'lastcall.me@hotmail.com' ORDER BY business_name LIMIT 5;
